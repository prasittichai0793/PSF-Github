    ...
    <div class="display-container">
        <div class="display-content">
            <div class="container-content">
                <div class="content">
                    <span>A เพิ่มข้อมูลพนักงานขับรถเครน</span>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tb_user (user_no, user_name, user_startDate, user_exp, user_idNumber, user_phoneNumber, user_Date, user_age, user_day, user_username, user_password, user_gender, position_id)
            VALUES ('$new_no', '$user_name', '$formatted_startDate', '$user_exp', '$user_idNumber', '$user_phoneNumber', '$formatted_user_age', '$user_age', '$user_leaveDays', '$user_username', '$user_password', '$user_gender', '1')";

...
<body>
    <div class="display-container">
        <div class="tool-for-table-container">
            <span>แผนกพนักงานขับรถเครน</span>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <td>
                                    <a href='edit_pos1.php?id={$row['user_id']}'class='btn btn-edit'><i class='fa fa-edit'></i> แก้ไข</a>
                                    <a href='delete_pos1.php?user_no=" . $row['user_no'] . "' class='btn btn-delete' onclick='return confirm(\"คุณต้องการลบข้อมูลพนักงานนี้หรือไม่?\")'><i class='fa fa-trash'></i>ลบ</a>
                                </td>
                            </tr>";
                            }
                        }

...
<head>
    ...
    <title>D เพิ่มข้อมูลพนักงานช่าง</title>
    ...
    <div class="display-container">
        <div class="display-content">
            <div class="container-content">
                <div class="content">
                    <span>D เพิ่มข้อมูลพนักงานช่าง</span>
                    <form action="add_pos4.php" method="post">
                        ...
                        <button type="button" class="btn btn-cancel" onclick="location.href='show_position4.php'"><i class="fas fa-times"></i>ยกเลิก</button>
                    </form>
                </div>
            </div>
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // ดึง user_no ล่าสุด
    $sql_last_no = "SELECT user_no FROM tb_user WHERE user_no LIKE 'D_%' ORDER BY user_no DESC LIMIT 1";
    ...
    $sql = "INSERT INTO tb_user (user_no, user_name, user_startDate, user_exp, user_idNumber, user_phoneNumber, user_Date, user_age, user_day, user_username, user_password, user_gender, position_id)
            VALUES ('$new_no', '$user_name', '$formatted_startDate', '$user_exp', '$user_idNumber', '$user_phoneNumber', '$formatted_user_age', '$user_age', '$user_leaveDays', '$user_username', '$user_password', '$user_gender', '4')";

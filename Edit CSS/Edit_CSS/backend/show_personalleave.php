...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['approve'])) {
        ...
        $sql = "UPDATE tb_personalleave SET PLeave_status='อนุมัติ', hr_id='$hr_id' WHERE PLeave_id='$pleave_id'";
    } elseif (isset($_POST['reject'])) {
        // เปลี่ยนสถานะเป็น 'ไม่อนุมัติ'
        $sql = "UPDATE tb_personalleave SET PLeave_status='ไม่อนุมัติ', hr_id='$hr_id' WHERE PLeave_id='$pleave_id'";
    }

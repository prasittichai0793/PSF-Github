...
<head>
    ...
    <title>แผนกพนักงานขับรถโฟล์คลิฟ</title>
...
<body>
    <div class="display-container">
        <div class="tool-for-table-container">
            <span>แผนกพนักงานขับรถโฟล์คลิฟ</span>
            <div class="button-tool-for-table-container">
                <a href="add_pos3.php" class="btn btn-add"><i class="fa fa-plus"></i> เพิ่มพนักงาน</a>
            ...
            <div class="table-container-inner">
                <table id="dataTable">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM tb_user WHERE position_id = 3";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <td>
                                    <a href='edit_pos3.php?id={$row['user_id']}'class='btn btn-edit'><i class='fa fa-edit'></i>แก้ไข</a>
                                    <a href='delete_pos3.php?user_no=" . $row['user_no'] . "' class='btn btn-delete' onclick='return confirm(\"คุณต้องการลบข้อมูลพนักงานนี้หรือไม่?\")'><i class='fa fa-trash'></i>ลบ</a>
                                </td>
                            </tr>";
                            }
                        }

...
<head>
    ...
    <title>C_เพิ่มข้อมูลพนักงานขับรถโฟล์คลิฟ</title>
        ...
        <div class="main-content">
            ...
            <div class="content">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    // ดึง user_no ล่าสุด
                    $sql_last_no = "SELECT user_no FROM tb_user WHERE user_no LIKE 'A_%' ORDER BY user_no DESC LIMIT 3";
                    ...
                    $sql = "INSERT INTO tb_user (user_no, user_name, user_startDate, user_exp, user_idNumber, user_phoneNumber, user_Date, user_age, user_username, user_password, user_gender, user_day,position_id)
                            VALUES ('$new_no', '$user_name', '$user_startDate', '$user_exp', '$user_idNumber', '$user_phoneNumber', '$user_Date', '$user_age', '$user_username', '$user_password', '$user_gender', '$leaveDays','3')";

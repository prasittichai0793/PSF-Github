...
<head>
    ...
    <link rel="stylesheet" href="css/position_3.css"> 
...
<body>
    <div class="container">
        <div class="main-content">
            <header>
                <h1>แผนกพนักงานขับรถโฟล์คลิฟ</h1>
                <div class="actions">
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <td>
                                    <a href='edit_pos3.php?id={$row['user_id']}'>แก้ไข</a>
                                    <a href='delete_pos3.php?user_no=" . $row['user_no'] . "' class='btn btn-delete' onclick='return confirm(\"คุณต้องการลบข้อมูลพนักงานนี้หรือไม่?\")'>ลบ</a>
                                </td>
                            </tr>";
                            }
                        }
